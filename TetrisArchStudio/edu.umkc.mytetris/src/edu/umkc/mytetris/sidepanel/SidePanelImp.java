...
public class SidePanelImp extends JPanel implements ISidePanelImp
{
	...
	*/
	...
	/**
	 * The tetrisImp instance.
	 */
	private TetrisImp tetrisImp;
	
	/**
	 * Creates a new SidePanelImp and sets it's display properties.
	 * @param tetrisImp The tetrisImp instance to use.
	 */
	public SidePanelImp(TetrisImp tetrisImp) {
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("Level: " + tetrisImp.getLevel(), LARGE_INSET, offset += TEXT_STRIDE);
		g.drawString("Score: " + tetrisImp.getScore(), LARGE_INSET, offset += TEXT_STRIDE);
		 ...
		 */
		TileType type = tetrisImp.getNextPieceType();
		if(!tetrisImp.isGameOver() && type != null) {
			/*
