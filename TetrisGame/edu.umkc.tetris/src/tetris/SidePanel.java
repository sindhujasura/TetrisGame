...
public class SidePanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		if (this.tetris != null
				&& "Player 2".equals(this.tetris.getTitle())) {
			g.setFont(LARGE_FONT);
			g.drawString("Controls For Player 2", SMALL_INSET-10, offset = CONTROLS_INSET);
			g.setFont(SMALL_FONT);
			g.drawString("Player2 : L-Move Left", SMALL_INSET -3, offset += TEXT_STRIDE);
			g.drawString("Player2 : J-Move Right", SMALL_INSET -3, offset += TEXT_STRIDE);
			g.drawString("Player2 : O-RotateAnticlockwise", SMALL_INSET-3, offset += TEXT_STRIDE);
			g.drawString("Player2 : I-Rotate Clockwise", SMALL_INSET-3, offset += TEXT_STRIDE);
			g.drawString("Player2 : K-Drop", SMALL_INSET-3, offset += TEXT_STRIDE);
			g.drawString("Player2 : U-Pause Game", SMALL_INSET-3, offset += TEXT_STRIDE);
		} else {
			g.setFont(LARGE_FONT);
			g.drawString("Controls For Player 1", SMALL_INSET-10, offset = CONTROLS_INSET);
			g.setFont(SMALL_FONT);
			
			g.drawString("Player1 : A - Move Left ", SMALL_INSET-3, offset += TEXT_STRIDE);
			g.drawString("Player1 : D - Move Right ", SMALL_INSET-3, offset += TEXT_STRIDE);
			g.drawString("Player1 : Q - RotateAnticlockwise ", SMALL_INSET-3, offset += TEXT_STRIDE);
			g.drawString("Player1 : E - Rotate Clockwise ", SMALL_INSET-3, offset += TEXT_STRIDE);
			g.drawString("Player1 : S - Drop ", SMALL_INSET-3, offset += TEXT_STRIDE);
			g.drawString("Player1 : P - Pause Game ", SMALL_INSET-3, offset += TEXT_STRIDE);
		}
